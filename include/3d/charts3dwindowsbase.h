...
#ifndef CHARTS3DWINDOWBASE_H
#define CHARTS3DWINDOWBASE_H
...
enum chart3dkeys{k_left3D=1,k_right3D=0x10,k_up3D=0x100,k_down3D=0x1000,k_control3D=0x10000,k_shift3D=0x100000,k_F123D=0x1000000};

#ifndef POINT_CLASS3D
#define POINT_CLASS3D

/** \class CHARTS3D_POINTD
		\brief Implements a point X Y using doubles.*/
class CHARTS3D_POINTD
{
public:
	CHARTS3D_POINTD(double x1=0, double y1=0){x=x1;y=y1;}
  double x;
  double y;
};
#endif//pointclass
